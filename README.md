...
This projects adds webhook functionality for Hasura. To use ..

- Create a new hasura server in cloud.hasura.io
- setup ngrok http 4000
- copy ngrokURL/webhook to hasura server env settings
- using graphqli, create a new user
- using postman, generate a JWT token using /authenticate endpoint
- create permission in hasura to allow user role
...
- [Switch to another database (e.g. PostgreSQL, MySQL, SQL Server)](#switch-to-anothraer-database-eg-postgresql-mysql-sql-server)
